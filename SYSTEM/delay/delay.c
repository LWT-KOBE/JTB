...
uint16_t Delay_s_Cnt = 0;	
	
__IO uint8_t flag_10Sec = 1;
__IO uint8_t flag_5Sec = 1;
__IO uint8_t flag_2Sec = 0;
__IO uint8_t flag_1Sec = 0;
__IO uint8_t flag_500mSec = 0;
__IO uint8_t flag_250mSec = 0;
__IO uint8_t flag_50mSec = 0;
__IO uint16_t flag_20mSec = 0;	

__IO uint16_t  gWifiSendMessageIsr;

__IO uint16_t pwrcount = 0;
	u8 eeprom = 0;
